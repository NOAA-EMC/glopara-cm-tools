...
if [ $CDUMP = 'gdas' ]; then
 ...
 /nwprod/util/ush/hpsstar get /NCEPPROD/hpssprod/runhistory/rh${YYYY}/${YYYY}${MM}/${YYYY}${MM}${DD}/${file} ./${dump}.t${CC}z.1bamua.tm00.bufr_d ./${dump}.t${CC}z.1bamub.tm00.bufr_d ./${dump}.t${CC}z.1bhrs3.tm00.bufr_d ./${dump}.t${CC}z.1bhrs4.tm00.bufr_d ./${dump}.t${CC}z.1bmhs.tm00.bufr_d ./${dump}.t${CC}z.adpsfc.tm00.bufr_d ./${dump}.t${CC}z.adpupa.tm00.bufr_d ./${dump}.t${CC}z.aircar.tm00.bufr_d ./${dump}.t${CC}z.aircft.tm00.bufr_d ./${dump}.t${CC}z.airsev.tm00.bufr_d ./${dump}.t${CC}z.atms.tm00.bufr_d ./${dump}.t${CC}z.ascatt.tm00.bufr_d ./${dump}.t${CC}z.ascatw.tm00.bufr_d ./${dump}.t${CC}z.avcsam.tm00.bufr_d ./${dump}.t${CC}z.avcspm.tm00.bufr_d ./${dump}.t${CC}z.esamua.tm00.bufr_d ./${dump}.t${CC}z.esamub.tm00.bufr_d ./${dump}.t${CC}z.eshrs3.tm00.bufr_d ./${dump}.t${CC}z.esmhs.tm00.bufr_d ./${dump}.t${CC}z.geoimr.tm00.bufr_d ./${dump}.t${CC}z.goesfv.tm00.bufr_d ./${dump}.t${CC}z.gome.tm00.bufr_d ./${dump}.t${CC}z.gpsipw.tm00.bufr_d ./${dump}.t${CC}z.gpsro.tm00.bufr_d ./${dump}.t${CC}z.engicegrb ./${dump}.t${CC}z.mls.tm00.bufr_d ./${dump}.t${CC}z.mtiasi.tm00.bufr_d ./${dump}.t${CC}z.omi.tm00.bufr_d ./${dump}.t${CC}z.osbuv8.tm00.bufr_d ./${dump}.t${CC}z.proflr.tm00.bufr_d ./${dump}.t${CC}z.rassda.tm00.bufr_d ./${dump}.t${CC}z.satwnd.tm00.bufr_d ./${dump}.t${CC}z.sevcsr.tm00.bufr_d ./${dump}.t${CC}z.sfcbog.tm00.bufr_d ./${dump}.t${CC}z.sfcshp.tm00.bufr_d ./${dump}.t${CC}z.snogrb ./${dump}.t${CC}z.snogrb_t382 ./${dump}.t${CC}z.snogrb_t574 ./${dump}.t${CC}z.sptrmm.tm00.bufr_d ./${dump}.t${CC}z.ssmisu.tm00.bufr_d ./${dump}.t${CC}z.sstgrb ./${dump}.t${CC}z.status.tm00.bufr_d ./${dump}.t${CC}z.updated.status.tm00.bufr_d ./${dump}.t${CC}z.syndata.tcvitals.tm00 ./${dump}.t${CC}z.vadwnd.tm00.bufr_d ./${dump}.t${CC}z.wdsatr.tm00.bufr_d ./${dump}.t${CC}z.wndsat.tm00.bufr_d
 ...
 mv ${dump}.t${CC}z.wdsatr.tm00.bufr_d wdsatr.${CDUMP}.${CDATE}
 mv ${dump}.t${CC}z.wndsat.tm00.bufr_d wndsat.${CDUMP}.${CDATE}
